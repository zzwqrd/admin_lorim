                  ...
                  <div class="row mb-4">
                        <div class="col-md-12 mb-4">
                              <div class="card text-left">
                                    ...
                                    <div class="card-body">
                                          <form id="change-pwd" action="show-admin-list.html" method="post">

                                                <div class="row">
                                                      <div class="col-md-6 form-group mb-3">
                                                            <label for="username">الإسم</label>
                                                            <input type="text" class="form-control" name="username"
                                                                  id="username" placeholder="الإسم" value="username"
                                                                  autocomplete="off">
                                                ...
                                                <div class="row">
                                                      ...
                                                      <div class="col-md-6 form-group mb-3">
                                                            ...
                                                            <!-- <span class="text-danger" role="alert">
                                                                  <strong>كلمه المرور مطلوبه ويجب ان لا تقل عن 8 حروف او
                                                                        ارقام</strong>
                                                            </span> -->
