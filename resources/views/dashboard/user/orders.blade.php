                                        ...
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    @switch($item->status)
                                                        @case(0)
                                                            <p href="{{ url('dashboard/user/suspend/' . $item->id) }}"
                                                                class="badge badge-warning "
                                                                style="width:80px;height: 25px;padding:auto;margin:auto;padding-top: 7px; font-size: small">
                                                                جديد</p>
                                                        @break
                                                    ...
                                                    <div class="dropdown dropleft text-right w-50">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1"
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('dashboard.orderStatus', ['id' => $item->id, 'status' => '1']) }}">تم
                                                                التأكيد</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('dashboard.orderStatus', ['id' => $item->id, 'status' => '3']) }}">تم
                                                                الشحن</a>
                                                            <a class="dropdown-item"
