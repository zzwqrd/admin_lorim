      ...
      <div class="app-admin-wrap layout-sidebar-large clearfix">
            <div class="main-header">
                  ...
                  <div class="header-part-right">
                        ...
                        <!-- Grid menu Dropdown -->
                        <div class="dropdown">
                              <i class="i-Safe-Box text-muted header-icon" id="dropdownMenuButton"
                                    data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false"></i>
                              ...
                              <div class="card text-left">
                                    <div class="card-header">
                                          <div class="card-title mb-3">
                                                <strong class="text-primary"> قائمة الشركاء</strong>
                                                <span class="align-baseline" style="display:inline;">
                                                      <a class="btn btn-primary " href="add-partners.html"
                                                            style="float: left">
                                                            <i class="i-Add align-middle"
                                    ...
                                    <div class="card-body">
                                          <div class="table-responsive">
                                                <table id="alternative_pagination_table"
                                                      ...
                                                      <tbody>
                                                            ...
                                                            <tr>
                                                                  <td>zein zein </td>
                                                                  <td>01004785693</td>
                                                                  <td>دمياط/الحي الثاني</td>
                                                                  <td>

                                                                        <!-- <a href="#" class="badge badge-success" style="width:auto;height: 25px;padding:auto;margin:auto;
                                                                          padding-top: 7px; font-size: small">5</a> -->
                                                                  ...
                                                                  <td style="text-align: center;">
                                                                        ...
                                                                        <a href="#" class="text-danger mr-2">
                                                                              <i
                                                                                    class="nav-icon i-Close-Window font-weight-bold delete-btn">
                                                                              </i>
                                                                        </a>
                                                                  </td>
