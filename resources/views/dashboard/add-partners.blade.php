                                                ...
                                                <div class="row">
                                                      <div class="col-md-6 form-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="name"
                                                                  id="name" placeholder="الإسم" autocomplete="off">
                                                      ...
                                                      <div class="col-md-6 form-group mb-3">
                                                            ...
                                                            <select class="form-control attribute" name="role"
                                                                  id="role">
                                                      ...
                                                      <div class="col-md-6 form-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="city"
                                                                  id="city" placeholder="المدينة" autocomplete="off">
                                                      ...
                                                      <div class="col-md-6 form-group mb-3">
                                                            ...
                                                            <input type="number" class="form-control" name="adr"
                                                                  id="adr" placeholder="العنوان" autocomplete="off">
                                                      ...
                                                      <div class="col-md-6 form-group mb-3">
                                                            ...
                                                            <input type="date" class="form-control" name="date"
                                                                  id="date" placeholder="تاريخ اليوم"
                                                                  autocomplete="off">
