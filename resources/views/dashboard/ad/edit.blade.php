        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header">
                    <div class="card-title mb-3"> <strong class="text-primary">تعديل إعلان</strong></div>
                </div>
                @include('dashboard.layouts.message')

                <div class="card-body">
                    <form id="change-pwd" action="{{ url('dashboard/ad/update') }}" method="post"
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <div class="avatar-upload" style="max-width: 350px">
                                    ...
                                    <div class="avatar-preview" style="width: 350px; height: 200px;border-radius: 10%;">
                                        <div id="imagePreview"
                                            style="background-image: url({{ config('ad_storage') . $data->image }});border-radius: 10%;">
                                        </div>
                                    </div>
                                    @if ($errors->has('image'))
